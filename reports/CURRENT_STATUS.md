...
| Reference Knowledge Base | 1 — Defined | yes | `knowledge/cosmologies/card.schema.json` |
...
| Confidence And Evaluation | 1 — Defined | yes | `docs/CONFIDENCE_AND_RANKING.md`, `evals/README.md` |
